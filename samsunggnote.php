...
<body style="background-color: yellow">
    ...
    <div class="pad1">
    <br>
        <u><h1>SAMSUNG GALAXY NOTE 20 ULTRA</h1></u>
    <center><img src="images/SamsungGalaxyNote20Ultra-.jpg" height="300px"><br></center>
<?php
        error_reporting(0);
    $conn = new mysqli('localhost','root','','mobile_shop');
    $sql = "SELECT * FROM product WHERE model_no='SM-N986BZNGINS';";
    ...
    if($resultcheck > 0){
     while($row = mysqli_fetch_assoc($result)){
        ...
        $conn->close;
?>
        <img class="iphone1" src="images/sgnp2.png" height="450px"><br> 
        <img class="iphone2" src="images/sgnp3.png" height="450px" width="500px"><br>
