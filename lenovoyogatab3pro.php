...
<body style="background-color: yellow">
    ...
    <div class="pad">
    <br>
        <u><h1>LENOVO YOGA TABLET 3 PRO</h1></u>
    <center><img src="images/lenovoyogatab3pro.jpg" height="300px"><br></center>
<?php
    error_reporting(0);
    $conn = new mysqli('localhost','root','','mobile_shop');
    $sql = "SELECT * FROM product WHERE model_no='YT3-X90L 64 GB';";
