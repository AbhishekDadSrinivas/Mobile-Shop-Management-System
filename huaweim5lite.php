...
<body style="background-color: yellow">
    ...
    <div class="pad">
    <br>
        <u><h1>HUAWEI MEDIAPAD M5 LITE</h1></u>
    <center><img src="images/huaweim5lite.jpg" height="300px"><br></center>
<?php
    error_reporting(0);
    $conn = new mysqli('localhost','root','','mobile_shop');
    $sql = "SELECT * FROM product WHERE model_no='D2';";
