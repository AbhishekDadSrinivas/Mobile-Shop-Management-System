...
<body style="background-color: yellow">
    ...
    <div class="pad1">
    <br>
        <u><h1>ONE PLUS 8 PRO</h1></u>
    <center><img src="images/oneplus8pro.png" height="300px"><br></center>
<?php
    error_reporting(0);
    $conn = new mysqli('localhost','root','','mobile_shop');
    $sql = "SELECT * FROM product WHERE model_no='IN2021';";
    ...
    if($resultcheck > 0){
     while($row = mysqli_fetch_assoc($result)){
        ...
        $conn->close;
?>
        <img class="iphone1" src="images/op8p2.png" height="450px"><br> 
        <img class="iphone2" src="images/op8p3.png" height="450px" width="200px"><br>
